...
func (req *Request) SAdd() *kvrpcpb.SetAddRequest {
	return req.req.(*kvrpcpb.SetAddRequest)
}
...
func CallRPC(ctx context.Context, client tinykvpb.TinyKvClient, req *Request) (*Response, error) {
	...
	case CmdSAdd:
		resp.Resp, err = client.SAdd(ctx, req.SAdd())
	case CmdCop:
